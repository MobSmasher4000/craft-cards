...
//            // 7. Regeneration Card
//            REGENERATION,
//            // 8. Water Breathing Card
//            WATER_BREATHING,
//            // 9. Looting Card
//            LOOTING,
//            // 10. Fortune Card
//            FORTUNE,
//            // 11. Fishing Efficiency Card
//            FISHING_EFFICIENCY,
//            // 12. Size Down Card
//            SIZE_DOWN,
//            // 13. Size Up Card
//            SIZE_UP,
//            // 14. Sharpness Card (Mapped to DAMAGE)
//            DAMAGE,
//            // 15. Attack Speed Card
//            ATTACK_SPEED,
//            // 16. Flying Speed Card
//            FLYING_SPEED,
//            // 17. Sneak Speed Card
//            SNEAK_SPEED,
//            // 18. Step Height
//            STEP_HEIGHT,
//            // 19. Underwater Movement Speed Card (Mapped to WATER_MOVEMENT_SPEED)
//            UNDERWATER_MOVEMENT_SPEED,
//            // 20. Block Reach Distance Card (Mapped to BLOCK_INTERACTION_RANGE)
//            BLOCK_INTERACTION_RANGE,
//            // 21. Entity Reach Distance Card (Mapped to ENTITY_INTERACTION_RANGE)
//            ENTITY_INTERACTION_RANGE,
//            // 22. Movement Speed Card (Mapped to SPEED_BOOST)
//            SPEED_BOOST,
//            // 23. Jump Boost Card
//            JUMP_BOOST,
//            // 24. Feather Falling Card
//            FEATHER_FALLING,
//            // 25. Armor Toughness Card
//            ARMOR_TOUGHNESS,
//            // 26. Armor Card
//            ARMOR,
//            // 27. Projectile Resistance Card
//            PROJECTILE_RESISTANCE,
//            // 28. Fire Resistance Card
//            FIRE_RESISTANCE,
//            // 29. Blast Resistance Card
//            BLAST_RESISTANCE,
//            // 30. Block Chance Card
//            BLOCK_CHANCE
//    };
    public static final TagKey<Item>[] CARD_CASE_SLOT_TAGS = new TagKey[] {
            // 1. Luck Card
    ...
    private static TagKey<Item> tagmaker(String name){
        return TagKey.of(RegistryKeys.ITEM,
                Identifier.of(CraftCards.MOD_ID, name));
    }
}
